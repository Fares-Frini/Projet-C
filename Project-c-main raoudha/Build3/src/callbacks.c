...
void on_list_polling_row_activated(GtkTreeView *treeview,
                                   GtkTreePath *path,
                                   GtkTreeViewColumn *column,
                                   gpointer user_data)
{/*
...
void on_polling_mod_clicked(GtkWidget *object,
                            gpointer user_data)
{
    GtkWidget *mod;
...
void on_polling_search_clicked(GtkWidget *object,
                               gpointer user_data)
{
}

void on_polling_add_clicked(GtkWidget *object,
                            gpointer user_data)
{
    GtkWidget *add;
...
void on_polling_del_clicked(GtkWidget *object,
                            gpointer user_data)
{
}
...
void on_addpolling_conf_toggled(GtkToggleButton *togglebutton,
                                gpointer user_data)
{
}

void on_addpolling_sub_clicked(GtkWidget *button,
                               gpointer user_data)
{
}

void on_modpolling_sub_clicked(GtkWidget *button,
                               gpointer user_data)
{
}
